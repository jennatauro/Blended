 ...
 */
public class BlendedRecyclerViewAdapter<T extends ModelViewHolder, VH extends BlendedRecyclerViewAdapter.RecyclerViewBaseHolder> extends RecyclerView.Adapter<VH> implements ViewAdapter<T>, StickyRecyclerHeadersAdapter {
    ...
    public static class RecyclerViewBaseHolder extends RecyclerView.ViewHolder {
        BlendedRecyclerViewAdapter mAdapter;

        public RecyclerViewBaseHolder(View view, BlendedRecyclerViewAdapter adapter) {
            super(view);
